 ...
 * @author Ho Hieu
 */
public class FindDrinkByIngredient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FindDrink</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FindDrink at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Drink> drinks = DAODrink.GetAllDrinkByIngredient(s);
        ...
        ArrayList<Drink> drinkForMenu = DAODrink.GetDrinkForIngredient(begin, end, count, s);
        ...
        request.setAttribute("ingredient", s);
        request.getRequestDispatcher("SearchForIngredient.jsp").forward(request, response);
