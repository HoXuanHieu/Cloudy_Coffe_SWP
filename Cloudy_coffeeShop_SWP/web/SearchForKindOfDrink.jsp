<%-- 
    Document   : SearchForKindOfDrink
    Created on : Oct 13, 2022, 10:05:25 PM
    Author     : Ho Hieu
--%>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto p-4">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Find Drink</a>
         ...
         <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
            <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
                <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">${Kind}</h1>
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <div class="section-title">
                    ...
                    <h1 class="display-4">${Kind} Menu</h1>
                </div>
            ...
            <ul class="pagination justify-content-center">
                ...
                <c:forEach var="i" begin="1" step="1" end="${TotalPage}">  
                    <li class="page-item"><a class="page-link" href="FindDrinkByKindOfDrink?PageNumber=${i}&find=${Kind}">${i}</a></li>             
                    </c:forEach>
                <li class="page-item disabled">
                    <p class="page-link">|</p>
                </li>
